  ...
  render: function(){
    ...
    return (
      React.createElement("span", {className: "tweet" + (tweet.active ? ' active' : '')}, 
        ...
        React.createElement("p", {className: "tweetBody"}, " ", React.createElement(Linkify, null, " ", tweet.body, " "), " ")
      )
    )
  }
});

},{"react":163,"react-linkify":8}],5:[function(require,module,exports){
/** @jsx React.DOM */
...
module.exports = Tweets = React.createClass({displayName: "Tweets",
  ...
  render: function(){
    ...
    return (
      React.createElement("span", {className: "tweets"}, content)
    )
